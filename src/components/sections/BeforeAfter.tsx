...
export function BeforeAfter({ projects }: { projects: Project[] }) {
  const items = projects.filter((p) => p.showBeforeAfter);
    ...
    <section id="antes-despues" className="relative py-32">
      <Container>
        ...
        <p className="mt-5 max-w-lg text-mist">
          Arrastra el separador para revelar la transformación de cada pieza: del footage crudo al resultado final.
        </p>
